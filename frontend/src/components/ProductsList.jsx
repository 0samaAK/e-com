				...
				<tbody className = 'bg-gray-800 divide-y divide-gray-700'>
					{
                        ...
                        products?.map((product) => (
                            ...
                            <tr key = {product.id} className = 'hover:bg-gray-700'>
                                ...
                                <td className = 'px-6 py-4 whitespace-nowrap'>
                                    <button onClick = { () => toggleFeaturedProduct(product.id, product.isFeatured) } className = { `p-1 rounded-full ${ product.isFeatured ? "bg-yellow-400 text-gray-900" : "bg-gray-600 text-gray-300" } hover:bg-yellow-500 transition-colors duration-200` }>
